            ...
            {requirements.map((req) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3 rounded-xl border transition-all duration-150 flex items-center gap-3 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#FF6B00]/20 ${isChecked
                ...
                >
                  {/* Custom Checkbox */}
                  <div
                    className={`w-5 h-5 rounded-md flex items-center justify-center transition-colors flex-shrink-0 ${isChecked
